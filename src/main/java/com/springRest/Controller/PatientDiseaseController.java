...
import com.springRest.service.PatientDiseaseService;
...
public class PatientDiseaseController {
    ...
    private PatientDiseaseService service;
    private DoctorService doctorService;
    private PatientService patientService;
    private DiseaseService diseaseService;

    public PatientDiseaseController(PatientDiseaseService service, DoctorService doctorService, PatientService patientService, DiseaseService diseaseService) {
    ...
    public String showUpdatePDForm(@RequestParam("pdID") Integer pdID, Model model, RedirectAttributes ra) {
        ...
        } catch (PatientDiseaseNotFoundException ex) {
    ...
    @PutMapping("/updatePD")
    public String updatePD(@RequestBody PatientDisease pd, RedirectAttributes ra){
        try {
            service.update(pd);
            //return message
